...
export default function TopSkills() {
  ...
  return (
    <motion.div
      ...
      className="items-center justify-center flex flex-col gap-y-5 py-10 mb-5"
    >
      <h3 className="text-3xl font-bold text-white mb-1 flex items-center sm:text-4xl">
        Top Skills
        <Dialog>
          <DialogTrigger asChild>
            <Button className="mx-5 sm:w-auto rounded-full bg-gradient-to-br from-primary-500 to-secondary-500 text-white font-bold py-2 px-4 hover:from-secondary-500 hover:to-primary-500">
              All Skills
            </Button>
          </DialogTrigger>
